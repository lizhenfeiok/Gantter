...
function initEvents (vm) {
  //TODO:vm._events =Object.create(null)？？
...
function Vue (options) {
  if ("development" !== 'production' &&
  //TODO:为什么构造函数中判断this instanceof 构造函数？
  //直接调用this instanceof Vue 等于false,new Vue()则等于true
  //是防止直接当函数调用的，必须采用new调用方式
    !(this instanceof Vue)
  ) {
